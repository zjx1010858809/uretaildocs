##0租户参照
#卡片中添加过滤的话需要在模板分组上添加cStyle：{"filterid":253138648,"classname":"listheadRow"}
#更新模板分组添加过滤方案
#set @style=CONCAT('{"filterid":',@id130,',"classname":"listheadRow"}');
#update billtplgroup_base set cStyle=@style where iBillId=@id4 and cCode='orderdetail_filter';
#注意：这段sql需要在0租户脚本中执行
...
set @filterName='rm_billingmembers';
set @solutionName='默认方案';
